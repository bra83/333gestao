...
const App: React.FC = () => {
  ...
  const handleDeleteExpense = (id:string) => { setData(prev=>({...prev, gastos:prev.gastos.filter(g=>g.id!==id)})); apiCall(new URLSearchParams({type:'gasto',action:'delete',id})); showToast('Removido!'); };
